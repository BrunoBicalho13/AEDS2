...
public class PrototipoMain{		
		...
		public static void main(String[] args) throws Exception{
			...
			Restaurante[] rFinal = Arrays.copyOf(r,r_ordenados); // cria um array do tamanho exato das entradas ( estava tendo erro por usar um array de 1000 posições)
            		merge(rFinal,0,r_ordenados -1);
            		fim = System.nanoTime();
            		...
            		for(int i = 0; i < r_ordenados; i++)
                		System.out.println(rFinal[i].formatar());

            		FileWriter arq = new FileWriter("892151_mergesort.txt");
